...
#pragma region CapsuleComponent
    ...
    CapsuleComponent = CreateDefaultSubobject<UCapsuleComponent>("PawnRoot");
...
#pragma region PlayerSprite
    ...
    PlayerSprite = CreateDefaultSubobject<UPaperSpriteComponent>("Pawn Visual");
...
#pragma region SpringArmComponent And Camera
    ...
    SpringArmComponent = CreateDefaultSubobject<USpringArmComponent>("CameraAttatchmentArm");
    ...
    SpringArmComponent->SetRelativeRotation(FRotator(0.f, -90.f, 0.f)); // brokennnnnn & not correct
    ...
    FollowCamera->SetOrthoWidth(5000);
...
void APlayerPawn::Tick(float DeltaTime)
{
     ...
     if(MovementRight != 0)
     {
        ...
        //CALL AddForce() on the CapsuleComponent's BodyInstance moving it on the Forward Direction * MovementRight * 1000000.0f
         CapsuleComponent->BodyInstance.AddForce(FVector::ForwardVector * MovementRight * 100000.0f);
     }
    //ENDIF
...
void APlayerPawn::Jump()
{
    ...
    if(bOnFloor == true)
    {
        ...
        CapsuleComponent->BodyInstance.AddForce(FVector(0.0f, 0.0f, 1.0f) * 800000.0f * 40.0f);
    }
    //ENDIF
}
